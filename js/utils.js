...
function setLoggedInAdmin(admin) {
    sessionStorage.setItem('bms_admin', JSON.stringify(admin));
    updateNavUser();
}

function getLoggedInUser() {
    const u = sessionStorage.getItem('bms_user');
    return u ? JSON.parse(u) : null;
}
function getLoggedInAdmin() {
    const u = sessionStorage.getItem('bms_admin');
    return u ? JSON.parse(u) : null;
}
function logout() {
...
function logoutAdmin() {
    sessionStorage.removeItem('bms_admin');
    updateNavUser();
